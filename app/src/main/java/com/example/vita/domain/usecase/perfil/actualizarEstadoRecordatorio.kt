...
import com.example.vita.work.WalkReminderWorker
...
class ManageReminderUseCase @Inject constructor(
    ...
    // Archivo local para guardar los estados
    ...
    operator fun invoke(tipo: String, activo: Boolean, hora: Int, minuto: Int) {
        // 1. Guardar en memoria permanente del teléfono
        ...
        val workRequest = when (tipo.lowercase()) {
            ...
            "caminar" -> OneTimeWorkRequestBuilder<WalkReminderWorker>()
    ...
    // FUNCIÓN NUEVA: Para leer el estado guardado
